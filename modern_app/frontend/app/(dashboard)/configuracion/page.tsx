...
export default function ConfiguracionPage() {
  ...
  function handleOpenReleases() {
    if (typeof window === "undefined") return;
    window.open("https://github.com/iante/scisonomics/releases", "_blank", "noopener,noreferrer");
  }
  ...
  return (
    <section className="space-y-4">
      ...
      <section className="card p-5">
        ...
        <div className="mt-4">
          <button className="btn-secondary" type="button" onClick={handleOpenReleases}>Buscar actualizaciones</button>
        </div>
      </section>
